    ...
    <nav className="hidden md:flex bg-black px-4 py-10 flex-col-justify-between border-r min-w-[16rem]">
      <div className='flex flex-col gap-11'>
        ...
        <div className='flex gap-3'>
            <img src="https://www.pngkey.com/png/full/28-287308_instagram-logo-text-white.png" alt="logo" width={100}
            height={60} />
        ...
        <button className='flex flex-row justify-center items-center gap-2 bg-white text-red-500 
